...
public class FieldPOIs {
    ...
    public static final Pose2d NET = new Pose2d(new Translation2d(7.28, 0.0), new Rotation2d());
    public static final Pose2d PROCESSOR = new Pose2d(new Translation2d(6.34, 0.9), Rotation2d.fromDegrees(-90.0));
