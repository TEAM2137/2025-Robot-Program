...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        controller.x().onTrue(Commands.runOnce(drive::xLock, drive));

        // Reset gyro to 0° when B button is pressed
        controller.b()
                .onTrue(Commands.runOnce(() ->drive.setPose(new Pose2d(drive.getPose().getTranslation(), new Rotation2d())),drive)
